    ...
    return (
        <div className="space-y-6">
            {comments.map((comment) => {
                // Handle different data structures (backend uses 'user', some parts might use 'creator')
                const authorData = comment.user || comment.creator;
                const authorName = authorData?.name || comment.author || 'Anonymous';
